...
class Box2<T extends Number> {
    ...
    // Только сам продукт может сравниваться с самим собой
    ...
    // Любой вид продукта может сравниваться с любым другим типом продукта
    ...
    // Один и тот же ВИД продукта сравнивается с таким же типом
