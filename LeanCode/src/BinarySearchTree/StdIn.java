...
/**
 *  The <tt>BinarySearchTree.BinarySearchTree.StdIn</tt> class provides static methods for reading strings
 ...
 *  <pre>
 *  while (!BinarySearchTree.BinarySearchTree.StdIn.hasNextChar()) {
 *      char c = BinarySearchTree.BinarySearchTree.StdIn.readChar();
 *      BinarySearchTree.BinarySearchTree.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (!BinarySearchTree.BinarySearchTree.StdIn.hasNextLine()) {
 *      String line = BinarySearchTree.BinarySearchTree.StdIn.readLine();
 *      BinarySearchTree.BinarySearchTree.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = BinarySearchTree.BinarySearchTree.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code BinarySearchTree.BinarySearchTree.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  Some of the main differences are summarized below:
 *  <ul>
 *  <li> {@code BinarySearchTree.BinarySearchTree.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code BinarySearchTree.BinarySearchTree.StdIn} uses whitespace as the delimiter between tokens.
 *  <li> {@code BinarySearchTree.BinarySearchTree.StdIn} coerces the character-set encoding to UTF-8,
 *       which is a standard character encoding for Unicode.
 *  <li> {@code BinarySearchTree.BinarySearchTree.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code BinarySearchTree.BinarySearchTree.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code BinarySearchTree.BinarySearchTree.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code BinarySearchTree.BinarySearchTree.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, <tt>BinarySearchTree.BinarySearchTree.StdIn</tt>
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to BinarySearchTree.BinarySearchTree.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to BinarySearchTree.BinarySearchTree.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to BinarySearchTree.BinarySearchTree.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to BinarySearchTree.BinarySearchTree.StdIn
    
    
    // do this once when BinarySearchTree.BinarySearchTree.StdIn is initialized
    static {
        resync();
    }

    /**
     * If BinarySearchTree.BinarySearchTree.StdIn changes, use this to reinitialize the scanner.
     */
