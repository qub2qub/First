...
/**
 *  The <tt>BinarySearchTree.BinarySearchTree.BST</tt> class represents an ordered symbol table of generic
 *  key-value pairs.
...
public class BST<Key extends Comparable<Key>, Value> {
    private Node root;             // root of BinarySearchTree.BinarySearchTree.BST
    ...
    // return number of key-value pairs in BinarySearchTree.BinarySearchTree.BST rooted at x
    ...
    /**
     * Returns the height of the BinarySearchTree.BinarySearchTree.BST (for debugging).
     *
     * @return the height of the BinarySearchTree.BinarySearchTree.BST (a 1-node tree has height 0)
     */
    public int height() {
        return height(root);
    }
    ...
    /**
     * Returns the keys in the BinarySearchTree.BinarySearchTree.BST in level order (for debugging).
     *
     * @return the keys in the BinarySearchTree.BinarySearchTree.BST in level order traversal
     */
    ...
    /*************************************************************************
     *  Check integrity of BinarySearchTree.BinarySearchTree.BST data structure.
     ***************************************************************************/
    ...
    // is the tree rooted at x a BinarySearchTree.BinarySearchTree.BST with all keys strictly between min and max
    ...
    /**
     * Unit tests the <tt>BinarySearchTree.BinarySearchTree.BST</tt> data type.
     */
